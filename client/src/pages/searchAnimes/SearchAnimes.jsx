      ...
      <main>
        ...
        {text && !info.data && (
          <span className="flex justify-center text-center text-sm tracking-tight">
            <img className="lg:w-[6rem] w-[2rem]" src="https://cdn.pixabay.com/animation/2022/10/11/03/16/03-16-39-160_512.gif" alt="" />
          </span>
        )}
        {info.data && (
          <ul className="grid  grid-cols-2 lg:grid-cols-5 mx-2 my-2 lg:mx-[10rem] lg:my-[10rem]">
            {info.data.map((anime) => (
              <li className="mb-5 rounded p-5 text-xl font-bold text-rose" key={anime.id}>
