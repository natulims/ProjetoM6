      ...
      <div className="flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0 bg-misty">
        ...
        <div className="w-full px-6 py-4 mt-6 overflow-hidden bg-red-50 shadow-md sm:max-w-lg sm:rounded-lg">
            ...
            <div>
              ...
              <div className="flex flex-col items-start">
                <input
                  type="text"
                  name="name"
                  className="block w-full mt-1 border-rusty rounded-md shadow-sm focus:border-auburn focus:ring focus:ring-rusty"
                />
              </div>
            </div>
            <div className="mt-4">
              ...
              <div className="flex flex-col items-start">
                <input
                  type="email"
                  name="email"
                  className="block w-full mt-1 border-rosy rounded-md shadow-sm focus:border-rusty focus:ring focus:ring-rusty"
                />
              </div>
            </div>
            <div className="mt-4">
              ...
              <div className="flex flex-col items-start">
                <input
                  type="password"
                  name="password"
                  className="block w-full mt-1 border-rusty rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                />
              </div>
            </div>
            <div className="mt-4">
              ...
              <div className="flex flex-col items-start">
                <input
                  ...
                  className="block w-full mt-1 border-rusty rounded-md shadow-sm focus:border-rusty focus:ring focus:ring-rusty"
                />
              </div>
            </div>
            <a href="#" className="text-xs text-rose hover:underline">
              Forget Password?
            </a>
          ...
          <div className="flex items-center w-full my-4">
            <hr className="w-full" />
            <p className="px-3 text-mountbatten">OR</p>
            <hr className="w-full" />
          </div>
